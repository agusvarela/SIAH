    ...
    t.expr[":"].notmdproc = function (o) {
        ...
        attachInputEventHandlers: function () {
            ...
            t(document).on("change", ".checkbox input[type=checkbox]", function () {
                ...
                "" === o.val() ? (i.addClass("is-empty"), i.removeClass("has-error"), i.removeClass("has-success")) : i.removeClass("is-empty"), n && (e ? (i.removeClass("has-error"), i.addClass("has-success")) : (i.removeClass("has-success"), i.addClass("has-error")))
