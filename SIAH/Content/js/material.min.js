    ...
    t.expr[":"].notmdproc = function (o) {
        ...
        attachInputEventHandlers: function () {
            ...
            t(document).on("change", ".checkbox input[type=checkbox]", function () {
                ...
                //i.append("<span style='visibility:hidden' id='succ' class='form-control-feedback material-icons'> done</span >");
                //i.append("<span style='visibility:hidden' id='error' class='material-icons form-control-feedback'>clear</span>");
                "" === o.val() ? (i.addClass("is-empty"), i.removeClass("has-error"), i.removeClass("has-success")) : i.removeClass("is-empty"), n && (e ? (i.removeClass("has-error"), i.addClass("has-success"), (document.getElementById("succ").style.visibility = 'visible'), (document.getElementById("error").style.visibility = 'hidden')) : (i.removeClass("has-success"), i.addClass("has-error"), (document.getElementById("succ").style.visibility = 'hidden'), (document.getElementById("error").style.visibility = 'visible')))
                ...
                if ("file" != o.attr("type")) {
                    var i = o.closest(".form-group"),
                        n = o.val();
                    n ? i.removeClass("is-empty") : (i.addClass("is-empty"), i.removeClass("has-error"), i.removeClass("has-success"))
                }
