...
(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            b = h("<div/>", {
                ...
                "class": b.sFilter
            }).append(h("<div class='form-group'></div>").append(j)),
            f = function() {
                var b = !this.value ?
                    "" : this.value;
                b != e.sSearch && (fa(a, {
    ...
    function nb(a) {
        ...
        var i = h("<div class='form-group'><label class='control-label'/></div>").addClass(b.sLength);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Mostrando de _START_ al _END_ de un total de _TOTAL_ filas",
            ...
            sSearch: "",
            sSearchPlaceholder: "Buscar en la tabla..",
            sUrl: "",
